...
helpers.sendTwilioSms = function (phone, msg, callback) {
    ...
    if (phone && msg) {
        ...
        // Instantiate athe request object
        ...
        // End the request i.e. send the request
        req.end();
...
// Add the universal header and footer to as tring and pass the provided data object to the header and footer for interpolation
    ...
    if(fileName){
        ...
        fs.readFile(publicDir+fileName, function(err, data){
            if(!err && data){
                ...
                callback('No fle could be found');
            }
        });
    } else {
